        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Data Analyst yang berfokus mengubah data mentah menjadi insight
              yang bernilai, Suka ngulik data dan menemukan cerita di balik
              angka
            </p>
            <div className="flex space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-lg flex items-center justify-center transition-colors duration-200"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a
                  href="mailto:ipanmuhamad91@gmail.com"
